...
var Engine = (function(global) {
    ...
    function init() {
      ...
      game.launch = function() {        
        ...
        //and create enemies accordingly
        if (game.level.name.toLowerCase() == "easy"){
          for(var i=0; i<5; i++)
          {
            var enemy = new Enemy();
        ...
        if (game.level.name.toLowerCase() == "medium"){
          for(var i=0; i<8; i++)
          {
            var enemy = new Enemy();
            allEnemies.push(enemy);
        ...
        if (game.level.name.toLowerCase() == "hardcore"){
          for(var i=0; i<10; i++)
          {
            var enemy = new Enemy();
            allEnemies.push(enemy);
        ...
        player.sprite = game.character.pic;        
        lastTime = Date.now();
        main();        
      };
    }
